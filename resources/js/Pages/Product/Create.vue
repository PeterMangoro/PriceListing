<template>
  <product-layout title="Create Product">
    <div>
...
import DetailForm from "@/Pages/Product/Partials/Create/DetailForm.vue";
import AttachmentForm from "@/Pages/Product/Partials/Create/AttachmentForm.vue";
