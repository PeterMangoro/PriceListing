<template>
  <service-layout title="Create Service">
    <div>
...
import DetailForm from "@/Pages/Service/Partials/Create/DetailForm.vue";
import AttachmentForm from "@/Pages/Service/Partials/Create/AttachmentForm.vue";
