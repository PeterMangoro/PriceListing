...
<template>
  <form-section @submitted="updateCarDetail">
    <template #title> Update Car Documents </template>

    <template #description>
      Upload Car related documents eg. User Manuals
      <p class="pt-4">
  ...
  <edit-document-list :documents="car.documents" path="attachments.show" />
  <edit-document-list
    :documents="car.trashed_documents"
