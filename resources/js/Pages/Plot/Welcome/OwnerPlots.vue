      ...
      <div class="px-2">
        <div id="plots" v-if="data.plots.data">
          <p class="text-2xl font-extrabold text-slate-50 border-b-4">
             Available Plots by {{ data.owner.name }}
          </p>
          <all-plots v-if="data.plots" :heading="'All Plots Supplied by ' + data.owner.name" :items="data.plots.data"
            :pagination="data.plots.links" routes="welcome.plots.owner" :route_parameter="data.owner.username" />
        </div>
      </div>
    </div>
</plot-layout>
