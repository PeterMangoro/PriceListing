...
<template>
  <form-section @submitted="updatePlotDetail">
    ...
    <template #description>
      <p class="text-slate-50">
        Upload Plot related documents eg. User Manuals
      </p>
        ...
        <div>
          <div class="
            ...
            <div class="space-y-1 text-center">
              ...
              <text-input id="document_title" ref="plotInput" v-model="form.document_title" type="text"
  ...
  <edit-document-list :documents="plot.documents" path="attachments.show" />
<edit-document-list :documents="plot.trashed_documents" path="attachments.show" />
</template>
<script setup>
import { ref } from "vue";
