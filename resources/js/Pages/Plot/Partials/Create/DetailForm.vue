  ...
  <form-section @submitted="createPlot">
    ...
    <template #form>
      ...
      <div class="col-span-6 sm:col-span-3">
                ...
                <TextInput id="size" v-model="form.size" type="number" step="0.001" min="0" class="block w-full mt-1"
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <TextInput id="price" v-model="form.price" type="number" step="0.01" class="block w-full mt-1" required
      ...
      <div class="col-span-6 sm:col-span-4" >
              ...
              <div class="flex justify-center px-6 pt-2 pb-2 mt-1 border-2 border-gray-300 border-dashed rounded-md ">
                <div class="space-y-1 text-center">
                  <div class="flex text-sm text-black">
                    <label for="file-upload"
                      class="font-medium text-indigo-600 bg-transparent bg-white rounded-md cursor-pointer hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                      <input id="images" @input="form.images = $event.target.files" type="file" multiple
                        @change="onFileChange" />
                    </label>
                  </div>
              ...
              <div class="flex justify-center px-6 pt-2 pb-2 mt-1 border-2 border-gray-300 border-dashed rounded-md ">
                <div class="space-y-1 text-center">
                  <div class="flex justify-between">
                    <InputLabel for="document" value="Document Title" class="m-auto" />
                    <TextInput id="document_title" v-model="form.document_title" type="text" class="block w-8/12 mt-1"
                      autofocus autocomplete="document_title" />
                  </div>
                  <InputError class="mt-2" :message="form.errors.document_title" />
                  <div class="flex text-sm text-black">
                    <label for="file-upload"
                      class="font-medium text-indigo-600 bg-transparent bg-white rounded-md cursor-pointer hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                      <input id="document" @input="form.document = $event.target.files[0]" type="file"
                        @change="onFileChange" />
                    </label>
                  </div>
