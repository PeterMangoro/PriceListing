<template>
  <div
    class="flex-row min-h-screen bg-gradient-to-r from-slate-200 via-slate-400 to-slate-200"
  >
    <Head :title="title" />
    ...
    <jet-banner />
    <nav class="sticky top-0 py-1 bg-slate-200">
...
<JetNavLink
    ...
    <header v-if="$slots.header" class="mb-2 shadow">
      <div
        class="px-4 py-6 mx-auto sm:px-6 lg:px-8 bg-gradient-to-r from-slate-200 via-slate-400 to-slate-200"
      >
        <slot name="header" />
      </div>
    </header>
