<template>
    <div class="bg-wood bg-cover min-h-screen bg-no-repeat text-slate-900">
      <Head :title="title" />
          ...
          <div class="flex justify-between">
            <div class="flex">
              ...
              <div class="flex items-center shrink-0">
                <Link :href="route('car_insurance.show')">
                  <p class="font-bold text-lg uppercase">Home</p>
                  <!-- Home -->
                </Link>
              </div>
              <!-- Navigation Links -->
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <JetNavLink
                  class=""
                  :href="route('car-insurance.create')"
                  :active="route().current('car-insurance.create')"
                  enter-active-class=""
                >
                  Add-New
                </JetNavLink>
                ...
                <JetNavLink
                  class=""
                  :href="route('car-insurance.index')"
                  :active="route().current('car-insurance.index')"
                  enter-active-class=""
                >
                  View-All
                </JetNavLink>
