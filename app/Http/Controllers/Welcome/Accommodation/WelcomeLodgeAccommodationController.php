...
class WelcomeLodgeAccommodationController extends Controller
{
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/showAllAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/showCategoryAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/showCategoryTypeAccommodations', [
    ...
    public function owner(User $owner)
    {
        ...
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/showOwnerAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/accommodationDetail', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/Recent/recentAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/TopTalks/topTalksAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/Discounted/discountedAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/Featured/featuredAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/SameLocation', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/TopTalks/topTalksCategoryTypeAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/TopTalks/topTalksCategoryAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/Featured/featuredCategoryTypeAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/Featured/featuredCategoryAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/Discounted/discountedCategoryTypeAccommodations', [
    ...
    {
        return Inertia::render('Mall/Accommodation/Welcome/Lodge/Discounted/discountedCategoryAccommodations', [
