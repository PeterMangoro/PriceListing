...
class WelcomePlotController extends Controller
{
    ...
    {
        return Inertia::render('Mall/Plot/Welcome/showAllPlots', [
    ...
    {
        return Inertia::render('Mall/Plot/Welcome/showOwnerPlots', [
    ...
    {
        return Inertia::render('Mall/Plot/Welcome/plotDetail', [
    ...
    {
        return Inertia::render('Mall/Plot/Welcome/sameCity', [
